...
// Define a noop function for default onPress handlers
const noop = () => { };
...
const ButtonIncorrect = ({
  ...
  <View style={styles.container}>
    <View style={[styles.content, styles.containerIncorrect]}>
      <View style={styles.row}>
        <Text style={styles.title}>Answer: {wordCorrect}</Text>
      </View>
...
const ButtonDisable = ({
  ...
  <View style={styles.container}>
    <View style={styles.content}>
      <Pressable onPress={onPress} style={[styles.button, styles.buttonDisable]}>
